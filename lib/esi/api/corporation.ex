defmodule ESI.API.Corporation do
  ...
  @type structures_opt ::
          {:language, nil | :de | :"en-us" | :fr | :ja | :ru | :ko}
          | {:page, nil | integer}
          | {:token, nil | String.t()}
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Bookmarks/get_corporations_corporation_id_bookmarks)
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Bookmarks/get_corporations_corporation_id_bookmarks_folders)
