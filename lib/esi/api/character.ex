defmodule ESI.API.Character do
  ...
  def update_mail_item(character_id, mail_id, opts \\ []) do
    %ESI.Request{
      verb: :put,
      path: "/characters/#{character_id}/mail/#{mail_id}/",
      opts_schema: %{contents: {:body, :required}, datasource: {:query, :optional}, token: {:query, :optional}},
      opts: Map.new(opts),
    }
  end
  ...
  def create_mail_labels(character_id, opts \\ []) do
    %ESI.Request{
      verb: :post,
      path: "/characters/#{character_id}/mail/labels/",
      opts_schema: %{datasource: {:query, :optional}, label: {:body, :required}, token: {:query, :optional}},
      opts: Map.new(opts),
    }
  end
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Opportunities/get_characters_character_id_opportunities)
  ...
  def update_calendar_event(character_id, event_id, opts \\ []) do
    %ESI.Request{
      verb: :put,
      path: "/characters/#{character_id}/calendar/#{event_id}/",
      opts_schema: %{datasource: {:query, :optional}, response: {:body, :required}, token: {:query, :optional}},
      opts: Map.new(opts),
    }
  end
  ...
  def mail(character_id, opts \\ []) do
    %ESI.Request{
      verb: :get,
      path: "/characters/#{character_id}/mail/",
      opts_schema: %{datasource: {:query, :optional}, labels: {:query, :optional}, last_mail_id: {:query, :optional}, token: {:query, :optional}},
      opts: Map.new(opts),
    }
  end
  ...
  def create_mail(character_id, opts \\ []) do
    %ESI.Request{
      verb: :post,
      path: "/characters/#{character_id}/mail/",
      opts_schema: %{datasource: {:query, :optional}, mail: {:body, :required}, token: {:query, :optional}},
      opts: Map.new(opts),
    }
  end
  ...
  def industry_jobs(character_id, opts \\ []) do
    %ESI.Request{
      verb: :get,
      path: "/characters/#{character_id}/industry/jobs/",
      opts_schema: %{datasource: {:query, :optional}, include_completed: {:query, :optional}, token: {:query, :optional}},
      opts: Map.new(opts),
    }
  end
  ...
  def create_asset_locations(character_id, opts \\ []) do
    %ESI.Request{
      verb: :post,
      path: "/characters/#{character_id}/assets/locations/",
      opts_schema: %{datasource: {:query, :optional}, item_ids: {:body, :required}, token: {:query, :optional}},
      opts: Map.new(opts),
    }
  end
  ...
  def calendar(character_id, opts \\ []) do
    %ESI.Request{
      verb: :get,
      path: "/characters/#{character_id}/calendar/",
      opts_schema: %{datasource: {:query, :optional}, from_event: {:query, :optional}, token: {:query, :optional}},
      opts: Map.new(opts),
    }
  end
  ...
  def delete_contacts(character_id, opts \\ []) do
    %ESI.Request{
      verb: :delete,
      path: "/characters/#{character_id}/contacts/",
      opts_schema: %{contact_ids: {:query, :required}, datasource: {:query, :optional}, token: {:query, :optional}},
      opts: Map.new(opts),
    }
  end
  ...
  @type create_contacts_opt :: {:contact_ids, [nil | integer]} | {:label_ids, nil | [integer]} | {:standing, float} | {:token, nil | String.t} | {:watched, nil | boolean}
  ...
  def create_contacts(character_id, opts \\ []) do
    %ESI.Request{
      verb: :post,
      path: "/characters/#{character_id}/contacts/",
      opts_schema: %{contact_ids: {:body, :required}, datasource: {:query, :optional}, label_ids: {:query, :optional}, standing: {:query, :required}, token: {:query, :optional}, watched: {:query, :optional}},
      opts: Map.new(opts),
    }
  end
  ...
  @type update_contacts_opt :: {:contact_ids, [nil | integer]} | {:label_ids, nil | [integer]} | {:standing, float} | {:token, nil | String.t} | {:watched, nil | boolean}
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Character/get_characters_character_id_stats)
  ...
  def create_cspa(character_id, opts \\ []) do
    %ESI.Request{
      verb: :post,
      path: "/characters/#{character_id}/cspa/",
      opts_schema: %{characters: {:body, :required}, datasource: {:query, :optional}, token: {:query, :optional}},
      opts: Map.new(opts),
    }
  end
  ...
  def wallet_transactions(character_id, opts \\ []) do
    %ESI.Request{
      verb: :get,
      path: "/characters/#{character_id}/wallet/transactions/",
      opts_schema: %{datasource: {:query, :optional}, from_id: {:query, :optional}, token: {:query, :optional}},
      opts: Map.new(opts),
    }
  end
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Bookmarks/get_characters_character_id_bookmarks_folders)
  ...
  @type search_opt :: {:categories, [:agent | :alliance | :character | :constellation | :corporation | :faction | :inventory_type | :region | :solar_system | :station | :structure]} | {:language, nil | :de | :"en-us" | :fr | :ja | :ru | :ko} | {:search, String.t} | {:strict, nil | boolean} | {:token, nil | String.t}
  ...
  def search(character_id, opts \\ []) do
    %ESI.Request{
      verb: :get,
      path: "/characters/#{character_id}/search/",
      opts_schema: %{categories: {:query, :required}, datasource: {:query, :optional}, language: {:query, :optional}, search: {:query, :required}, strict: {:query, :optional}, token: {:query, :optional}},
      opts: Map.new(opts),
    }
  end
  ...
  @type create_fittings_opt :: {:fitting, [description: String.t, items: [[flag: :Cargo | :DroneBay | :FighterBay | :HiSlot0 | :HiSlot1 | :HiSlot2 | :HiSlot3 | :HiSlot4 | :HiSlot5 | :HiSlot6 | :HiSlot7 | :Invalid | :LoSlot0 | :LoSlot1 | :LoSlot2 | :LoSlot3 | :LoSlot4 | :LoSlot5 | :LoSlot6 | :LoSlot7 | :MedSlot0 | :MedSlot1 | :MedSlot2 | :MedSlot3 | :MedSlot4 | :MedSlot5 | :MedSlot6 | :MedSlot7 | :RigSlot0 | :RigSlot1 | :RigSlot2 | :ServiceSlot0 | :ServiceSlot1 | :ServiceSlot2 | :ServiceSlot3 | :ServiceSlot4 | :ServiceSlot5 | :ServiceSlot6 | :ServiceSlot7 | :SubSystemSlot0 | :SubSystemSlot1 | :SubSystemSlot2 | :SubSystemSlot3, quantity: integer, type_id: integer]], name: String.t, ship_type_id: integer]} | {:token, nil | String.t}
  ...
  def create_fittings(character_id, opts \\ []) do
    %ESI.Request{
      verb: :post,
      path: "/characters/#{character_id}/fittings/",
      opts_schema: %{datasource: {:query, :optional}, fitting: {:body, :required}, token: {:query, :optional}},
      opts: Map.new(opts),
    }
  end
  ...
  [View on ESI Site](https://esi.evetech.net/latest/#!/Bookmarks/get_characters_character_id_bookmarks)
